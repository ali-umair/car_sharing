...
export default function Navbar(props: any) {
  ...
  return (
    <nav className="w-[90%] sm:w-4/5 sticky top-4 z-10 bg-slate-50 dark:bg-neutral-800 px-4 py-2.5 mt-4 flex justify-between items-center rounded-lg shadow-lg dark:shadow-neutral-950">
      <div className="">
